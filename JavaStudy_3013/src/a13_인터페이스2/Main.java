...
public class Main {
	...
	public static void main(String[] args) {
		...
		userData.setUsers(new User[scanner.nextInt()]); //회원을 저장할 배열의 크기를 지정하고 생성된 배열을 UserData 객체의 users배열 변수에 set하는 것
		scanner.nextLine();//위의 nextInt()후에 버퍼에 저장된 엔터를 날려주기 위함.
